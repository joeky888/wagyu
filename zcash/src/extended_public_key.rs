...
impl<N: ZcashNetwork> PartialEq for ZcashExtendedPublicKey<N> {
    fn eq(&self, other: &Self) -> bool {
        self.extended_full_viewing_key == other.extended_full_viewing_key
    }
}
...
mod tests {
    ...
    fn test_from_str<N: ZcashNetwork>(expected_extended_public_key: &str) {
        let extended_public_key = ZcashExtendedPublicKey::<N>::from_str(&expected_extended_public_key).unwrap();
        assert_eq!(expected_extended_public_key, extended_public_key.to_string());
    }
    ...
    mod sapling_mainnet {
        ...
        const KEYPAIRS: [(&str, &str, &str, &str, &str); 5] = [
            (
                ...
                "",
            ...
            (
                ...
                "",
            ...
            (
                ...
                "",
            ...
            (
                ...
                "",
            ...
            (
                ...
                "",
        ...
        fn from_extended_private_key() {
            KEYPAIRS.iter().for_each(|(path, seed, _, extended_public_key, _)| {
                test_from_extended_private_key::<N>(extended_public_key, seed, path);
            });
        }
        ...
        #[test]
        fn from_str() {
            KEYPAIRS.iter().for_each(|(_, _, _, extended_public_key, _)| {
                test_from_str::<N>(extended_public_key);
            });
        }
        ...
        fn to_string() {
            KEYPAIRS.iter().for_each(|(path, seed, _, extended_public_key, _)| {
                test_to_string::<N>(extended_public_key, seed, path);
            });
        }
    }
    ...
    mod sapling_testnet {
        ...
        const KEYPAIRS: [(&str, &str, &str, &str, &str); 5] = [
            (
                ...
                "",
            ...
            (
                ...
                "",
            ...
            (
                ...
                "",
            ...
            (
                ...
                "",
            ...
            (
                ...
                "",
